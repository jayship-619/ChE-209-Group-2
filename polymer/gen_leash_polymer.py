...
for i in range(num_primary_arms):
    ...
    for k in range(branch_arms):
        ...
        if k%2 == 0 : 
            for b in range(branch_length-1):
                ...
                if b == branch_length - 2 : 
                    loops.append(atom_id)
...
bonds.append([1,loops[0],loops[3]])
bonds.append([1,loops[1],loops[2]])
bonds.append([1,loops[4],loops[5]])
...
with open("leash.data", "w") as f:
    # Header
    f.write("LAMMPS data file for branched Leash polymer\n\n")
...
print(f"Generated 'leash.data' successfully.")